        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-20 pb-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">Sales Analytics</h1>
                    <p className="text-sm text-gray-600">Track revenue, costs, and profitability</p>
                </div>
                    ...
                    >
                        <div className="flex items-center justify-between mb-3">
                            <div className="w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center">
                                <Icons.ShoppingBag className="w-5 h-5 text-orange-600" />
                            </div>
                        ...
                        <p className="text-xs text-gray-500">Total Cost of Goods</p>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                <Icons.ShoppingBag className="w-5 h-5 text-blue-600" />
                            </div>
                            <div>
